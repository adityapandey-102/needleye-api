...
flowchart TD
    ...
    ApiV1 --> R1["/auth<br/>modules/auth/api/auth.routes.ts"]
    ...
    Repo --> DrizzleDB[("db<br/>common/database/drizzle-client.ts")]
    DrizzleDB --> Postgres[("PostgreSQL<br/>via DATABASE_URL")]
