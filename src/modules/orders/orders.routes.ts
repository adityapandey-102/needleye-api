...
import { SupabaseOrdersRepository } from "./orders.repository";
import { OrdersMapper } from "./orders.mapper";
import { storageProvider } from "../../common/storage/supabase-storage-provider";

/** Composition root for the Orders module. */
const ordersService = new OrdersService(new SupabaseOrdersRepository(), new OrdersMapper(storageProvider), storageProvider);
